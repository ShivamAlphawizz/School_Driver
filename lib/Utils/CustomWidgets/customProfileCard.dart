          ...
          child: Row(
            ...
            children: [
              Column(
                ...
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
                  Text("Job ID - " + jobId, style: TextStyle(fontWeight: FontWeight.bold, fontFamily: 'Serif'),),
                  Text(name, style: TextStyle(fontWeight: FontWeight.bold, fontFamily: 'Serif'),),
                  Row(
                    children: [
                      Image.asset('assets/AuthAssets/Icon ionic-ios-call.png', color: primaryColor, scale: 1.5,),
                      SizedBox(width: 10,),
                      Text(mobileNumber, style: TextStyle(color: greyColor2, fontFamily: 'Serif'),),
                    ],
                  ),
                  Row(
                    children: [
                      ...
                      SizedBox(width: 10,),
                      Text(email, style: TextStyle(color: greyColor2, fontFamily: 'Serif'),),
                    ],
                  )
                ],
              ),
